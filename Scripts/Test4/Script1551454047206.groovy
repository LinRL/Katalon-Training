...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_LOGIN Panel_txtUsername'), usernmae)
...
WebUI.verifyElementClickable(findTestObject('Page_OrangeHRM/a_Logout'))
